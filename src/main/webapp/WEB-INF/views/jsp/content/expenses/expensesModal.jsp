...
<script>
	...
	$('#expenseItem').on('shown.bs.modal', function() {
		initialize();
...
<div class="modal fade" id="expenseItem" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Dodaj wydatek</h4>
			</div>

			<div class="modal-body">
				<sf:form method="POST" modelAttribute="expenseEntity"
