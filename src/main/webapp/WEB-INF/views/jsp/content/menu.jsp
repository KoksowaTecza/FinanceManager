...
<div>
	<h4>Welcome ${sessionScope['scopedTarget.spitterEntity'].username}</h4>
	<div id="obraz">
		<img src="/images/${sessionScope['scopedTarget.spitterEntity'].profile_image}.jpg" width="140px" height="140px" class="img-thumbnail" />
	</div>
	<div id="menu_button">
